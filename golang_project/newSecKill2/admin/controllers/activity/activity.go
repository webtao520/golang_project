...
func (this *ActivityController) Index() {
	...
	this.TplName = "activity/index.html"
	return
}
...
func (this *ActivityController) AddActivity() {
	if this.Ctx.Input.IsPost() {
		...
		num, err := ActivityModel.InsertActivity(&activity)
		if err != nil {
			this.Error(err)
			return
		}
		fmt.Println("添加活动id", num)
		...
		this.TplName = "activity/add.html"
	}
	return
}
...
func (this *ActivityController) UpdateActivity() {
	...
	if this.Ctx.Input.IsPost() {
		...
		this.TplName = "activity/edit.html"
	}
	return
}
...
func (this *ActivityController) getDataFormHtml() (activity models.SecKillActivity, err error) {
	...
	*/
	...
	if err != nil {
		err = errors.New("EveryoneLimit 必须是数字")
		return
	}
